  <header class="fixed top-0 left-0 w-full z-50 bg-white shadow-sm">
          ...
          <div id="mobile-search-bar" class="lg:hidden hidden py-3 border-t border-gray-100">
              <div class="relative">
                  <div
                      ...
                      <!-- Close (X) Button -->
                      <button id="mobile-search-close" class="ml-2 text-gray-500 hover:text-gray-700 transition-smooth">
                  ...
                  <div id="mobile-search-suggestions"
                      ...
                      <div class="p-2 max-h-60 overflow-y-auto">
                          <a href="#" class="flex items-center p-2 hover:bg-gray-50 rounded transition-smooth">
                              <i class="fas fa-ring text-amber-600 mr-3"></i>
                              <div>
                                  <p class="font-medium text-gray-800">Solitaire Diamond Ring</p>
                                  <p class="text-sm text-gray-600">₹24,999</p>
      ...
      <div id="mobile-menu" class="lg:hidden hidden fixed inset-0 z-50">
          <!-- Overlay -->
          <div class="absolute inset-0 bg-transparent" id="menu-overlay"></div>
